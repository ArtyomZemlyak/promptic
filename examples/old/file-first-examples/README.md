...
**Usage:**
```bash
promtic preview examples/tutorials/file-first-examples/code-review/code_review_workflow.yaml --render-mode file_first
```
...
**Usage:**
```bash
promtic preview examples/tutorials/file-first-examples/data-analysis/data_analysis_pipeline.yaml --render-mode file_first
```
...
**Usage:**
```bash
promtic preview examples/tutorials/file-first-examples/content-generation/content_generation_workflow.yaml --render-mode file_first
```
...
**Usage:**
```bash
promtic preview examples/tutorials/file-first-examples/decision-making/decision_making_process.yaml --render-mode file_first
```
...
```bash
# Basic preview
promtic preview examples/tutorials/file-first-examples/<example-name>/<blueprint>.yaml --render-mode file_first

# With base URL for absolute links
promtic preview examples/tutorials/file-first-examples/<example-name>/<blueprint>.yaml --render-mode file_first --base-url https://kb.example.com
```
...
result = previewer.render("examples/tutorials/file-first-examples/code-review/code_review_workflow.yaml")
...
1. Create a new directory under `examples/tutorials/file-first-examples/`
