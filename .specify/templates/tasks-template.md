...
- [ ] T017 [US1] Add logging for user story 1 operations and document decisions with `# AICODE-NOTE`
...
- [ ] T029 [US3] Update docs_site entries and inline documentation for this story
...
- [ ] TXXX [P] Documentation updates in docs/ and close any outstanding `# AICODE-ASK` items
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit tests in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Execute `pre-commit run --all-files` plus the full pytest suite and attach results to the PR
